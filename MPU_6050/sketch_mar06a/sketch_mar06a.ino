...
float SEq_1 = 1, SEq_2 = 0, SEq_3 = 0, SEq_4 = 0,x,y,z,w,roll,yaw,pitch; // estimated orientation quaternion elements with initial conditions
...
void setup() {
  ...
  Serial.begin(115200);
  Serial.println("AcclerometerX,AcclerometerY,AcclerometerZ,GyroscopeX,GyroscopeY,GyroscopeZ,MagnetometerX,MagnetometerY,MagnetometerZ,Roll,Pitch,Yaw");
  while(!Serial) {}
...
void loop() {
  // read the sensor
  IMU.readSensor();
  filterUpdate(IMU.getGyroX_rads(), IMU.getGyroY_rads(), IMU.getGyroZ_rads(),IMU.getAccelX_mss(), IMU.getAccelY_mss(), IMU.getAccelZ_mss(), IMU.getMagX_uT(), IMU.getMagY_uT(), IMU.getMagZ_uT());
//  Serial.print(q0,6);
//  Serial.print("~");
//    Serial.print(q1,6);
//  Serial.print("~");
